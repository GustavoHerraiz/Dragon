...
// Instancia de la red desde analisisDeDefinicion.js
const red = new RedAnalisisDefinicion().network; // Accedemos directamente a la red neuronal
...
function entrenarModelo() {
    ...
    fs.writeFileSync('./RedDeDefinicion_Entrenada.json', JSON.stringify(redEntrenada, null, 2));
    console.log('✅ Red entrenada guardada en RedDeDefinicion_Entrenada.json');
}
